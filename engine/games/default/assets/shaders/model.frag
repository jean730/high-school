...
void main()
{
vec3 skycolor = vec3(0.8,0.8,0.9)*((1.0F+sin(time/1000.0F))/2.0F*0.8+0.2);
Light sun;
sun.direction = vec3(1,0.9,0.3);
sun.ambient = skycolor*0.2;
sun.diffuse = skycolor;
sun.specular = skycolor;
